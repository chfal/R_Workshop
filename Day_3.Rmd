...
However, I'll reupdate the GitHub at the end so everyone has working code by the end of the day. In addition, to see how I prepared for this workshop (mainly because live coding demos stress me out), check out the "iris_analyses.Rmd" folder.
